            ...
            <div className="flex items-center justify-center min-h-screen">
                ...
                <div className="relative bg-gray-50 shadow-xl rounded-2xl max-w-sm mx-auto p-5 min-w-[420px]">
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className="mb-3 flex flex-col gap-2">
                            <label htmlFor="input_role_id">Role</label>
                            <select name="role_id" defaultValue={data.role_id} className={`px-4 py-2 rounded shadow ${errors.role_id ? 'border-red-500' : ''}`} id="input_role_id" >
