                ...
                <div className="flex items-center justify-between mt-6">
                    <div className="relative flex items-center">
                        ...
                        <input
                            ...
                            onChange={searchData}
                            type="text"
                            className="text-gray-600 pl-10 pr-4 py-2 border rounded-xl max-w-[20px] focus:max-w-[200px] focus:md:max-w-max transition-width absolute left-0 md:max-w-max"
                        />
                    </div>
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {drivers.data.map((item, i) => (
                                <DriverRow destroy={destroy} edit={edit} key={i} item={item} />
                            ))}
                            {drivers.total == 0 && (
                                <tr>
                                    <td
